...
public class Differential implements Externalizable,Cloneable {
	 ...
	 */
	public ArrayList<Difference> keyDifferences = new ArrayList<Difference>();
	@XmlElement
	/**
	 * A list of state differences. The i-th element represents the differences in 
	 * the states after round i.  
	 */
	public ArrayList<Difference> stateDifferences = new ArrayList<Difference>();
	@XmlElement
	/**
	 ...
	 */
	public ArrayList<Difference> intermediateStateDifferences = new ArrayList<Difference>();
	@XmlElement
	/**
    ...
    public Differential(ByteArray firstSecretKey, ByteArray keyDifference, ByteArray secondSecretKey) {
        this.firstSecretKey = firstSecretKey;
        this.keyDifference = keyDifference;
        this.secondSecretKey = secondSecretKey;
    }
	...
	private String updateString(ArrayList<Difference> differences, int round, String identifier) {
	...
	private void andElementsIfNotZeroAt(ArrayList<Difference> first, ArrayList<Difference> second, int index) {
		if (first.get(index) != null && second.get(index) != null) {
			first.get(index).and(second.get(index));
		}
	}
	
	private void orElementsIfNotZeroAt(ArrayList<Difference> first, ArrayList<Difference> second, int index) {
		if (first.get(index) != null && second.get(index) != null) {
			first.get(index).or(second.get(index));
		}
	}
	
	private void xorElementsIfNotZeroAt(ArrayList<Difference> first, ArrayList<Difference> second, int index) {
		if (first.get(index) != null && second.get(index) != null) {
	...
	private ArrayList<Difference> readVector(ObjectInput input) throws IOException, ClassNotFoundException {
	...
	private void writeVector(ArrayList<Difference> vector, ObjectOutput output) throws IOException {
		if (vector == null) {
			vector = new ArrayList<Difference>();
		}
